...
int main()
{
	...
	sf::Texture Potion2;
	Potion2.loadFromFile("png/box.png");

	sf::Texture Potion3;
	Potion3.loadFromFile("png/Potion1.png");
	...
	enemy2.rect.setPosition(810, 610);
	enemyArrey2.push_back(enemy2);
	enemy2.rect.setPosition(-1, 620);
	enemyArrey2.push_back(enemy2);
	enemy2.rect.setPosition(820, -1);
	enemyArrey2.push_back(enemy2);
	enemy2.rect.setPosition(-10, 100);
	enemyArrey2.push_back(enemy2);
	enemy2.rect.setPosition(815, -3);
	enemyArrey2.push_back(enemy2);
	enemy2.rect.setPosition(805, -4);
	enemyArrey2.push_back(enemy2);
	...
	pickUp2.rect.setSize(sf::Vector2f(63.5, 64));
	...
	pickUp3.rect.setPosition(400, 400);
	pickUp3.rect.setSize(sf::Vector2f(63.5, 64));
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			while (state2)
			{
				...
				{
					if (Player1.rect.getGlobalBounds().intersects(pickUpArrey2[counter].rect.getGlobalBounds()))
					{
						if (pickUpArrey2[counter].isPotion == true)
						{
							Player1.gil += pickUpArrey2[counter].potionValue;
						}
						pickUpArrey2[counter].destroy = true;
					}
				...
				for (iter = projectileArrey.begin(); iter != projectileArrey.end(); iter++)
				{
					...
					for (iter5 = enemyArrey2.begin(); iter5 != enemyArrey2.end(); iter5++)
					{
						if (projectileArrey[counter].rect.getGlobalBounds().intersects(enemyArrey2[counter2].rect.getGlobalBounds()))
						{
							//cout << "Collision" << endl;
							projectileArrey[counter].destroy = true;
							Player1.gil1 += enemyArrey2[counter].enemyValue;  // ยิงแล้วคะแนนเพิ่ม
				...
				for (iter5 = enemyArrey2.begin(); iter5 != enemyArrey2.end(); iter5++)
				{
					if (enemyArrey2[counter].alive == false)
					{
						...
						if (generateRandom(4) == 1)
						{
							pickUp2.rect.setPosition(enemyArrey2[counter].rect.getPosition());
							pickUpArrey2.push_back(pickUp2);
						}

						enemyArrey2.erase(iter4);
						break;
					}
					counter++;
				}
				...
				for (iter10 = pickUpArrey2.begin(); iter10 != pickUpArrey2.end(); iter10++)
				{
					if (pickUpArrey2[counter].destroy == true)
					{
						cout << "Chon" << endl;
						pickUpArrey2.erase(iter10);
						break;
					}
					counter++;
				}
				...
				for (iter10 = pickUpArrey2.begin(); iter10 != pickUpArrey2.end(); iter10++)
				{
					...
					pickUpArrey2[counter].updateMovement2();
					//window.draw(pickUpArrey[counter].rect);
				...
				for (iter5 = enemyArrey2.begin(); iter5 != enemyArrey2.end(); iter5++)
				{
					...
					{
						enemyArrey2[counter].rect.move(-playerMovementSpeed, 0);
					}
					...
					{
						enemyArrey2[counter].rect.move(0, -playerMovementSpeed);
					}
			...
			while (state3)
			{
				...
				for (iter = projectileArrey.begin(); iter != projectileArrey.end(); iter++)
				{
					...
					for (iter6 = enemyArrey3.begin(); iter6 != enemyArrey3.end(); iter6++)
					{
						if (projectileArrey[counter].rect.getGlobalBounds().intersects(enemyArrey3[counter2].rect.getGlobalBounds()))
						{
							//cout << "Collision" << endl;
							projectileArrey[counter].destroy = true;
							Player1.gil1 += enemyArrey3[counter].enemyValue;  // ยิงแล้วคะแนนเพิ่ม
